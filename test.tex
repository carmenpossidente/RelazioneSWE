...
\texttt{@BeforeEach}. Per facilitare questa pulizia, i vincoli referenziali vengono 
temporaneamente disabilitati tramite il comando \texttt{SET REFERENTIAL\_INTEGRITY FALSE}, 
permettendo lo svuotamento delle tabelle in qualsiasi ordine. Questo approccio 
garantisce che ogni test parta da uno stato noto e perfettamente isolato, eliminando 
alla radice il rischio di \textit{flaky test} causati da dati residui.
