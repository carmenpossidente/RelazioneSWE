...
\begin{itemize}
    ...
    \begin{figure}[ht]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=0.7\textwidth]{img/snippet_BT.png}}
        \caption{Snippet 1 - BalanceTest }
    \end{figure}
    ...
    \begin{figure}[ht]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{img/snippet_ET.png}}
        \caption{Snippet 2 - ExpenseTest }
    \end{figure}
    ...
    \begin{figure}[ht]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=0.9\textwidth]{img/snippet_MT.png}}
        \caption{Snippet 3 - MembershipTest }
    \end{figure}
...
\begin{figure}[ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=0.7\textwidth]{img/snippet_SN.png}}
    \caption{Snippet 4 - StubNavigator }
\end{figure}
